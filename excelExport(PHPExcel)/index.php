<?php
    ...
    $link = mysqli_connect($host, $user, $pass); // Соединяемся с СУБД
    mysqli_select_db($link, "korolev"); // Выбор БД
    ...
    require_once("PHPExcel.php"); // Подключение класса для работы с Excel
    ...
    $activeSheet->setTitle("Пользователи");
    ...
    $select_all_data_from_chat = mysqli_query($link, "SELECT * FROM chat");
    

    while($data_from_db = mysqli_fetch_array($select_all_data_from_chat))
    {
